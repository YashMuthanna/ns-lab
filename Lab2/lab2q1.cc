...
Ptr<ConstantPositionMobilityModel> s0 = p2pNodes.Get(0)->GetObject<ConstantPositionMobilityModel>();
Ptr<ConstantPositionMobilityModel> s1 = p2pNodes.Get(1)->GetObject<ConstantPositionMobilityModel>();
Ptr<ConstantPositionMobilityModel> s2 = p2pNodes.Get(2)->GetObject<ConstantPositionMobilityModel>();
// Additional nodes if needed
s0->SetPosition(Vector(0, 0, 0));
s1->SetPosition(Vector(30, 0, 0));
s2->SetPosition(Vector(90, 0, 0));
// Set positions for additional nodes if needed
