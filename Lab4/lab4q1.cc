...
main (int argc, char *argv[])
{
  ...
  // Create constant position mobility models and set positions for all nodes
  ...
  s1->SetPosition(Vector(10, 0, 0));
  s2->SetPosition(Vector(20, 0, 0));
  s3->SetPosition(Vector(30, 0, 0));
  s4->SetPosition(Vector(40, 0, 0));
    AsciiTraceHelper ascii;
